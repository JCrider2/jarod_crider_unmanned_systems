...
from unmanned_systems_ros2_pkg import DijkstraFun
...
def main()->None:
    ...
    obs_x = [5,5,5,5,5,0,1,2,3,3]
    
    obs_y = [0,1,2,3,4,5,4,3,2,3]
    
    start = (2,1)
    finish = (7,2)
    map = [(0,10),(0,10),0.5]    

    text = open("/home/jarod/ros2_ws/src/unmanned_systems_ros2_pkg/unmanned_systems_ros2_pkg/log/plannedPath.txt", "a")
    wp_list = DijkstraFun.DijkstraFun(map,obs_x,obs_y,0.33,finish,start,0.15)
    text.write(str(wp_list))
    text.close()
